    ...
    public void addFacilityDetail(Facility f, String detail) {
        switch (detail) {
            case "ID":
                ...
                f.setFacilityID(user.nextInt());
                System.out.println("Facility ID is now " + f.getFacilityID());
            ...
            case "Maintenance Cost":
                ...
                System.out.println("Facility maintenance cost is now " + f.getFacilityMaintenanceCost());
